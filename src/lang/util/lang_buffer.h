...
LANG_UTIL_BUFFER_API void        lang_buffer_destroy(lang_buffer*);
...
static inline void lang_buffer_pushp  (lang_buffer* buffer, void*    value) { lang_buffer_append(buffer, &value, sizeof(value)); }
